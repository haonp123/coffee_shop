        ...
        <div className={cx('wrapper')}>
            <div className={cx('inner')}>
                ...
                <div className={cx('content')}>
                    <p>
                        Highlands Coffee CPG thuộc Công ty TNHH MTV Thái Kiên tự hào là đơn vị phân phối hợp lệ và độc
                        quyền cho tất cả các sản phẩm đóng gói mang thương hiệu Highlands Coffee®- Thương hiệu cà phê
                        sinh ra từ đất Việt.
                    </p>
                    <p>
                        Từ tình yêu với Việt Nam và niềm đam mê cà phê, năm 1999, thương hiệu Highlands Coffee® ra đời
                        với khát vọng nâng tầm di sản cà phê lâu đời của Việt Nam và lan rộng tinh thần tự hào, kết nối
                        hài hoà giữa truyền thống với hiện đại.
                    </p>
                    <p>
                        Bắt đầu với sản phẩm cà phê đóng gói tại Hà Nội vào năm 2000, chúng tôi đã nhanh chóng phát
                        triển và mở rộng thành thương hiệu quán cà phê nổi tiếng và không ngừng mở rộng hoạt động trong
                        và ngoài nước từ năm 2002.
                    </p>
                    <p>
                        Qua một chặng đường dài, chúng tôi đã không ngừng mang đến những sản phẩm cà phê thơm ngon, sánh
                    ...
                    <p>
                        Đến nay, Highlands Coffee® vẫn duy trì khâu phân loại cà phê bằng tay để chọn ra từng hạt cà phê
                        ...
                        đáo với mức giá phù hợp.
                    </p>
                    <p>
                        Không chỉ dừng lại ở đó, Highlands Coffee® mong muốn đưa hương vị cà phê đến gần hơn với nhiều
